...
This website is a clone of a popular Ecommerce brand built with React JS together with the Sanity CMS for content management. 

Stripe payment gateway is used for payment processing.

Real world example of a Ecommerce platform
